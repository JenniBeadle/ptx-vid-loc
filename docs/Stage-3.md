...
[**Overview pdf**](https://drive.google.com/file/d/1ChMwYAlpddW3ImuNg07k8MnHzZsXJjp0/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1FmERTYoItLWt5H_CbSX2BryQ9y3I8jnz/view?usp=sharing)  
- **Opening screen** Biblical terms tool with no comparative texts showing 
- **Prep**: 
  - Text to translate for annotation
    - Comparative texts
  - several terms with renderings marked and guessed. [A comparative translation with renderings.]
  - choose several resources to add as comparative texts.
...
[**Overview pdf**](https://drive.google.com/file/d/1bKh8vATiNrlMKznJtoKLznsZfLCmGvDz/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1qR0lWyNK5zP1jK3_AAvhlMoEpfjCwRdL/view?usp=sharing)  
- **Opening screen**  MTT2  Biblical terms, filter set to Rom 1:1, several comparative texts
terms translit, no comp texts, one comp. text with terms rendered
- **Prep**: 
  - term "gift" with missing renderings  (need permission to edit the following verses)
    - in 1Co 12:4 due to typo in the text
    - in 1Pe 4:10 uses a synonym.
    - in 2Co 1:11  different but acceptable translation 
  - Text to translate for annotations
    - Consistent
    - I need you to check the renderings of a Biblical Term…
    - Check the term gift
    - Discuss 1Co 12:30 with the team and community reviewers.
...
[**Overview pdf**](https://drive.google.com/file/d/1Fh2F1HSnMGwEjc2KQFB3cs4zxc_v1F3L/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1RWskQaEri25NF2gUjim-tSYHJCiGiDv6/view?usp=sharing)  
- **Opening screen** Mat 1:1 with right click menu > View Biblical Terms
- **Prep**: 
  -  MTT2. Tools>Clear Guessed Renderings. 
  -  screenshots
     -  0:38 right-click
     -  1:33 filter
     -  5:44 guess renderings
  -  name for the names filter 
  -  terms with orange background
  -  terms with wrong guess
  -  Text to translate for annotations
        -  Shift+Click - span
        -  Ctrl+click - rows
...
[**Overview pdf**](https://drive.google.com/file/d/1Ut4Fi3xewOMpIYfPqv0CrTiPXSlvahOH/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1B5eEMZbmI5ovdsg8dolub8AFKc8m6jOw/view?usp=sharing)  
- **Opening screen**  
- **Prep**: 
  - text to translate for slides
    - What is a back translation?  
      1. A way to check the translation.  
      2. In a major language that the consultant understands
      3. In Paratext it is a separate linked project.
    - What are the qualities of a good back translation?
      - Done by someone not part of the translation team.
      - Natural, reflect their understanding of the vernacular
      - Not use other helps or Bibles
      - They should reflect the vernacular text as written.

  - Back translation done and marked complete for Mat 1 
...
[**Overview pdf**](https://drive.google.com/file/d/1Ut4Fi3xewOMpIYfPqv0CrTiPXSlvahOH/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1B5eEMZbmI5ovdsg8dolub8AFKc8m6jOw/view?usp=sharing)  
- **Opening screen** Mat 1:0
  - **Prep**
      - Project plan with waiting for stage 2
      - deal with outstanding tasks so that Mat 1 is ready for back translation.
  ...
  -  Text to translate for slide
     -  A back translation needs a new empty project
...
[**Overview pdf**](https://drive.google.com/file/d/14yVZ78lDv6CV0hGUY-0bf2lMx2JJOcB-/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1w33FriBe0YoxqakcQ11-PxxvHUr9UTam/view?usp=sharing)  
- **Opening screen**  Mat 1:1 proj / back translation (in standard view)
- **Prep**: 
  - - Text to translate for annotation
      - Draft Back Translation in Basic View
      - Uneditable
    - Prepare the back translation to type for 3 verses
...
- **Opening screen**  Mat 1 complete back translation
- **Prep**: 
  - complete back translation of Mat 1
  - text to translate for note
    - This does not seem accurate.

### \# 81 - 3.3	How and When to Use the Interlinearizer (3.3)
:::danger Upgrade
This video has been revised and split into two a and b.
:::
:::note Video
...
[**Overview pdf**](https://drive.google.com/file/d/1Fdb2d350wJpfHEJHuD2IqyTs7nKOZk6E/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1GODfpqGxCiNJ9iP2-IxhhPRhvTuHAMoG/view?usp=sharing)  
- **Opening screen**  Mat 14:5 proj interlineariser on screen  
- **Prep**: 
  - text to translate for slide
    - 1. Supplement a back translation.
      - Use the existing translation as the model text
    - 2. Get the gist of an unknown language
      - Use a published Bible as the Model Text
    - 3. Literal Back Translation
      - Use empty back translation as Model Text
    - Combination:
...
:::tip
For this video, you need to use a project where you know the glosses of several words/phrases.  
:::
## Basic Checks
...
[**Overview pdf**](https://drive.google.com/file/d/1vSEa7hlKoQ6GYwynVjRXW4p5CZDQdnPO/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1w5jn5agAbs28U4_mEiGHOkNI9NktPZdE/view?usp=sharing)  
- **Opening screen** text chapter with section
heading and reference markers 
- **Prep**: 
  - screenshot Scripture Reference Settings
  - screenshot Scripture Reference Settings - book tab
  - text to translate: 
    - Scripture Reference Settings
    - References are check in 
      - Cross-references \x \xo \xt
      - Parallel references \ior \r
      - Footnotes \fr
...
[**Overview pdf**](https://drive.google.com/file/d/1w-itplqXiLbBsgvzWnnA09YSdNomB0CB/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1NZ98kX0JeVBqsAMV3JxtrlQgBnecUEPD/view?usp=sharing)  
- **Opening screen**  Jhn 1:13
- **Prep**: 
  - Screenshot Project Plan checks
  - Assign Quotations check to the user 
    ...
    - various quotation errors. 
      - closing quote without opening quote
      - expected continuer
      - closing quote without opening quote
    - more errors in Luke
    - text to translate for callout
...
[**Overview pdf**](https://drive.google.com/file/d/1Gw9rKcF3qOu_y12EbqLj_JHNsaTeQp4w/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/15c4-ALpfWi_iRbfNUJYFBrTf_0d_lSaJ/view?usp=sharing)  
- **Opening screen** Mat 6:1 
with footnote pane open, res/text coll 
(text in quotation marks on
screen, footnote with quoted text \fq)

- **Prep**: 
  - assign Quoted text to user
  - add examples of verses and footnotes with errors
...
[**Overview pdf**](https://drive.google.com/file/d/18wCMrtnkP2a4b2ILcB9ooixrpKNuIMON/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1ciraE3iwbLmCKJ7BIbD3bXEZBPUyveam/view?usp=sharing)  
- **Opening screen** Mat 4:13 project /
list results / enhanced resource 
- **Prep**: 
  - assign Unmatched pairs check to user
  - ( ) around \r line. 
  - Type 0 in place of ) in another verse
  - Text to translate
    - (Parentheses)
    - [Square brackets]
    - {Curly brackets}
    -  Quotations check
 -  Projet plan with tasks
...
- **Opening screen** MTT2 
- **Prep**: 
Used MTT2 with feeding the 5000 altered in 3 ways in 3 different gospels. (Prior also changed the Numbers settings to accept curved quotes around numbers to eradicate some unnecessary errors.) I will upload with errors in place.   
...
:::note Video
[![ ](media/3.4f.png)](https://vimeo.com/686342856)  
https://vimeo.com/686342856
:::

[**Overview pdf**](https://drive.google.com/file/d/1dvBSp4QBfouYT4lIfXcWfWLhckZEFZvr/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1rzvU3DKCVp3DFHcTk3BC7ZjEuB-0_O-N/view?usp=sharing)
...
[**Overview pdf**](https://drive.google.com/file/d/1C0Va9FWFx60XKscZM89ix53AjUJK2ouI/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1eyVLubvmbvUbaHt7fPul-aNtJvC9B02c/view?usp=sharing)  
...
[**Overview pdf**](https://drive.google.com/file/d/1s12IOmvhGnB9kJ68B2AuJQoJIoTkKwEp/view?usp=sharing)  / [**Actions srt**](https://drive.google.com/file/d/1lyh2hi9kg27NHzdXmenEeW3IvahgoTaM/view?usp=sharing)  
